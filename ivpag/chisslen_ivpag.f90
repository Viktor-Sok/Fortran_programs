...
param(4)=1000000
param(10)=1          !способ определения нормы погрешности
param(12)=2          !метод Гира
param(13)=1         !численное вычисление Якобиана-2,аналитическое-1
param(14)=1          !ленточная форма хранения матрицы Якоби
param(15)=1          !число нижних поддиагоналей
param(16)=1          !число верхних наддиагоналей
param(19)=0          !решаем явную систему
istep=0              
ido=1
t=0.0
do while (istep<time)
...
write (1,*) 'Колличество высислений якобиана=',param(36)
end program lab1
...
dypdy(1,1)=0; dypdy(1,2)=0 !заполнение матрицы Якоби в ленточной форме хранения (по диагоналям)
do i=2,n
